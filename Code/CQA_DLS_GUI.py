...
#LOG
#29-08-2025 
    #Added lines class 'MyGUI' as per instructions Niels. 
    #
...
class MyGUI():
    def __init__(self, root):
        ...
        self.data_path =  r"R:\Projects\phys\p0728-automation\ICoNEA\Testset"
        self.save_path = r"R:\Projects\phys\p0728-automation\ICoNEA\CQA"
        #self.control_limits_file = r"C:\Users\p70078935\Maastro\CDS Informatics - Documents\PersOn\Daniël\3rd paper\CQA-GDD\Control limits.json"
        self.exclusion_path = r"C:\Users\p70078935\Maastro\CDS Informatics - Documents\PersOn\Daniël\3rd paper\CQA-GDD\ROI_exclusions.csv"
        self.N_min = 3
        self.xdim, self.ydim, self.zdim = 1.269, 1.269, 3.0
